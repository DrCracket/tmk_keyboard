...
#define AC_FN10 ACTION_LAYER_MODS(5, MOD_LSFT)
#define AC_FN11 ACTION_LAYER_MODS(5, MOD_RSFT)
#define AC_FN12 ACTION_MACRO(PIPE)
#define AC_FN13 ACTION_MACRO(BRACKET_L)
#define AC_FN14 ACTION_MACRO(BRACKET_R)
#define AC_FN15 ACTION_MACRO(BACKSLASH)
#define AC_FN16 ACTION_MACRO(BRACE_L)
#define AC_FN17 ACTION_MACRO(BRACE_R)
...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
    ...
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,FN12,TRNS,TRNS,    TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,FN13,FN14,TRNS,TRNS,                       TRNS,TRNS,TRNS,TRNS,TRNS,
    FN10,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     FN11,         TRNS,         TRNS,TRNS,TRNS,TRNS,
    ...
    /* Layer 5: programming layer 2 (shift pressed) */
    [5] = UNIMAP_ADB(
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,         TRNS,TRNS,TRNS,              TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,FN15,TRNS,TRNS,    TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,FN16,FN17,TRNS,TRNS,                       TRNS,TRNS,TRNS,TRNS,TRNS,
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt)
{
    ...
    switch (id) {
        ...
        case BACKSLASH:
            return (event.pressed ?
                    MACRO( SM(), CM(), D(RALT), T(MINS), U(RALT), RM(), END ):
                    MACRO( END ) );
        case BRACE_L:
            return (event.pressed ?
